...
public static class SpriteBatchExtensions
{
    ...
    public static Vector2 DrawString(this SpriteBatch spriteBatch, DynamicSpriteFont spriteFont, string? str, Vector2 location, Vector2 spacing, Color color)
    {
    ...
    /// <param name="color">The color of the text.</param>
    /// <returns>Size of the drawn string, in pixels.</returns>
    public static Vector2 DrawString(this SpriteBatch spriteBatch, DynamicSpriteFont spriteFont, string? str, Vector2 location, Vector2 maxBounds, Vector2 spacing, Color color)
    {
    ...
    /// <param name="color">The color of the text.</param>
    /// <returns>Size of the drawn string, in pixels.</returns>
    public static Vector2 DrawString(this SpriteBatch spriteBatch, DynamicSpriteFont spriteFont, string? str, Vector2 location, Vector2 maxBounds, Vector2 scale, Vector2 spacing, Color color)
    {
    ...
    /// <param name="color">The color of the text.</param>
    /// <returns>Size of the drawn string, in pixels.</returns>
    public static Vector2 DrawString(this SpriteBatch spriteBatch, DynamicSpriteFont spriteFont, string? str, Vector2 location, Color color)
    {
    ...
    /// <param name="color">The color of the text.</param>
    /// <returns>Size of the drawn string, in pixels.</returns>
    public static Vector2 DrawString(this SpriteBatch spriteBatch, DynamicSpriteFont spriteFont, string? str, Vector2 location, float characterSpacing, float lineHeight, Color color)
    {
    ...
    /// <param name="color">The color of the text.</param>
    /// <returns>Size of the drawn string, in pixels.</returns>
    public static Vector2 DrawString(this SpriteBatch spriteBatch, DynamicSpriteFont spriteFont, string? str, Vector2 location, Vector2 maxBounds, float characterSpacing, float lineHeight, Color color)
    {
    ...
    /// <param name="color">The color of the text.</param>
    /// <returns>Size of the drawn string, in pixels.</returns>
    public static Vector2 DrawString(this SpriteBatch spriteBatch, DynamicSpriteFont spriteFont, string? str, Vector2 location, Vector2 maxBounds, Vector2 scale, float characterSpacing, float lineHeight, Color color)
    {
        if (!spriteFont.CanDraw)
        {
            throw new InvalidOperationException();
