...
namespace RetroEngine.Csg
{
	...
	public class Polygon
	{
		...
		CsgBoundingSphere? cachedBoundingSphere;
		...
		public CsgBoundingSphere BoundingSphere
		{
			get
			{
				if (cachedBoundingSphere == null)
				{
					...
					cachedBoundingSphere = new CsgBoundingSphere { Center = middle, Radius = radius };
				}
				return cachedBoundingSphere;
			}
		}

		public CsgBoundingBox BoundingBox
		{
			get
			{
				if (cachedBoundingBox == null)
				{
					...
					cachedBoundingBox = new CsgBoundingBox(minpoint, maxpoint);
				}
