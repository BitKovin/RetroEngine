...
#pragma warning restore RECS0018 // Comparison of floating point numbers with equality operator
	...
	public class CsgBoundingBox
	{
		public readonly Vector3D Min;
		public readonly Vector3D Max;
		public CsgBoundingBox(Vector3D min, Vector3D max)
		{
			Min = min;
			Max = max;
		}
		public CsgBoundingBox At(Vector3D position, Vector3D size)
		{
			return new CsgBoundingBox(position, position + size);
		}
		public CsgBoundingBox(double dx, double dy, double dz)
		{
		...
		public static CsgBoundingBox operator +(CsgBoundingBox a, Vector3D b)
		{
			return new CsgBoundingBox(a.Min + b, a.Max + b);
		}
		public bool Intersects(CsgBoundingBox b)
		{
	...
	public class CsgBoundingSphere
	{
