...
namespace DotRecast.Core
{
    ...
    {
        public static RcObjImporterContext LoadContext(byte[] chunk, float scale = 1)
        {
        ...
        private static void ReadVertex(string line, RcObjImporterContext context)
        {
            if (line.StartsWith("v "))
            {
                ...
                context.vertexPositions.Add(vert.X * context.Scale);
                context.vertexPositions.Add(vert.Y * context.Scale);
                context.vertexPositions.Add(vert.Z * context.Scale);
            }
        }
