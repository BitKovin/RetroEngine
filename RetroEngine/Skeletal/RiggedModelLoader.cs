...
namespace RetroEngine.Skeletal
{
    ...
    public class RiggedModelLoader
    {
        ...
        public RiggedModel LoadAsset(string filePathorFileName, int defaultAnimatedFramesPerSecondLod)
        {
            ...
            string filepathorname = filePathorFileName;
            //
        ...
        public void CreateOriginalAnimations(RiggedModel model, Scene scene)
        {
            ...
            for (int i = 0; i < scene.Animations.Count; i++)
            {
                ...
                // Default.
                modelAnim.TotalFrames = (int)(modelAnim.DurationInSeconds * defaultAnimatedFramesPerSecondLod);
                modelAnim.TicksPerFramePerSecond = modelAnim.TicksPerSecond / defaultAnimatedFramesPerSecondLod;
