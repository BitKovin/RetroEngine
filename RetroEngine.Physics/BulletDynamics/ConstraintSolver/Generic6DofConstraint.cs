...
namespace BulletXNA.BulletDynamics
{
	public class Generic6DofConstraint : TypedConstraint
	{
        ...
        public Generic6DofConstraint(RigidBody rbA, RigidBody rbB, IndexedMatrix frameInA, IndexedMatrix frameInB, bool useLinearReferenceFrameA)
    : base(TypedConstraintType.D6_CONSTRAINT_TYPE, rbA, rbB)
        {
            m_frameInA = frameInA;
            m_frameInB = frameInB;
		...
		*/
        ...
        public void SetParam(ConstraintParams num, float value, int axis = 0)
        {
            if ((axis >= 0) && (axis < 3))
            {
                switch (num)
