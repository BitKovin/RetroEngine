...
namespace BulletXNA.BulletDynamics
{
    public class RigidBody : CollisionObject
    {
        ...
        public IndexedBasisMatrix InvInertiaTensorWorld
        {
            get { return m_invInertiaTensorWorld; }
            set { m_invInertiaTensorWorld = value; }
        }

        public IndexedVector3 LinearVelocity
        {
        ...
        public float InverseMass
        {
            ...
            set { m_inverseMass = value; }
        }

        public IndexedVector3 LinearFactor
        {
            get { return m_linearFactor; }
            set { m_linearFactor = value; }
        }
        ...
        public IndexedVector3 GravityAcceleration
        {
            get { return m_gravity_acceleration; }
            set { m_gravity_acceleration = value; }
        }

        public IndexedVector3 InvInertiaLocal
        {
            get { return m_invInertiaLocal; }
            set { m_invInertiaLocal = value; }
        }

        public IndexedVector3 TotalForce
        {
            get { return m_totalForce; }
            set { m_totalForce = value; }
        }

        public IndexedVector3 TotalTorque
        {
            get { return m_totalTorque; }
            set { m_totalTorque = value; }
        }
        ...
        {
            get { return m_additionalDamping; }
            set { m_additionalDamping = value; }
        }

        public float AdditionalDampingFactor
        {
            get { return m_additionalDampingFactor; }
            set { m_additionalDampingFactor = value; }
        }

        public float AdditionalLinearDampingThresholdSqr
        {
            get { return m_additionalLinearDampingThresholdSqr; }
            set { m_additionalLinearDampingThresholdSqr = value; }
        }

        public float AdditionalAngularDampingThresholdSqr
        {
            get { return m_additionalAngularDampingThresholdSqr; }
            set { m_additionalAngularDampingThresholdSqr = value; }
        }

        public float AdditionalAngularDampingFactor
        {
            get { return m_additionalAngularDampingFactor; }
            set { m_additionalAngularDampingFactor = value; }
        }

        public float LinearSleepingThreshold
        {
            get { return m_linearSleepingThreshold; }
            set { m_linearSleepingThreshold = value; }
        }

        public float AngularSleepingThreshold
        {
            get { return m_angularSleepingThreshold; }
            set { m_angularSleepingThreshold = value; }
        }

        public IMotionState OptionalMotionState
        {
            get { return m_optionalMotionState; }
            set { m_optionalMotionState = value; }
        }

        public IList<TypedConstraint> ConstraintRefs
        {
            get { return m_constraintRefs; }
            set { m_constraintRefs = value; }
        }

        public RigidBodyFlags RigidBodyFlags
        {
            get { return m_rigidbodyFlags; }
            set { m_rigidbodyFlags = value; }
        }

        public int DebugBodyId
        {
            get { return m_debugBodyId; }
            set { m_debugBodyId = value; }
        }

        public IndexedVector3 DeltaLinearVelocity
        {
            get { return m_deltaLinearVelocity; }
            set { m_deltaLinearVelocity = value; }
        }

        public IndexedVector3 DeltaAngularVelocity
        {
            get { return m_deltaAngularVelocity; }
            set { m_deltaAngularVelocity = value; }
        }

        public IndexedVector3 AngularFactor
        {
            get { return m_angularFactor; }
            set { m_angularFactor = value; }
        }

        public IndexedVector3 InvMass
        {
            get { return m_invMass; }
            set { m_invMass = value; }
        }

        public IndexedVector3 PushVelocity
        {
            get { return m_pushVelocity; }
            set { m_pushVelocity = value; }
        }

        public IndexedVector3 TurnVelocity
        {
            get { return m_turnVelocity; }
            set { m_turnVelocity = value; }
        }
        ...
        {
	        m_internalType=CollisionObjectTypes.RigidBody;
	        ...
	        UpdateInertiaTensor();
            m_rigidbodyFlags = RigidBodyFlags.None;
	    ...
	    {
		    if ((colObj.GetInternalType()&CollisionObjectTypes.RigidBody) != 0)
            {
        ...
        public void ApplyCentralImpulse(IndexedVector3 impulse)
        {
	    ...
	    {
            if ((GetActivationState() == ActivationState.IslandSleeping) || (GetActivationState() == ActivationState.DisableDeactivation))
            {
			    return;
            }
	    ...
	    public bool	WantsSleeping()
	    {
		    ...
		    if (GetActivationState() == ActivationState.DisableDeactivation)
            {
			    return false;
            }
            ...
            if ((GetActivationState() == ActivationState.IslandSleeping) || (GetActivationState() == ActivationState.WantsDeactivation))
            {
			    return true;
            }
