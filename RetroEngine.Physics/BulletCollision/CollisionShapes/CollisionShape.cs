...
namespace BulletXNA.BulletCollision
{
    public abstract class CollisionShape
    {
		...
		public IndexedVector3 CalculateLocalInertia(float mass)
		{
			this.CalculateLocalInertia(mass, out IndexedVector3 inertia);
			return inertia;
		}
        ...
        public void CalculateLocalInertia(float mass, out Vector3 inertia)
        {
            ...
            inertia = new IndexedVector3(elem).ToVector3();
        }
