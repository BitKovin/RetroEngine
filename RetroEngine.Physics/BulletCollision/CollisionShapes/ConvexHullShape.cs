...
namespace BulletXNA.BulletCollision
{
    public class ConvexHullShape : PolyhedralConvexAabbCachingShape
    {
		...
		public ConvexHullShape(IList<Microsoft.Xna.Framework.Vector3> points)
		{

			List<IndexedVector3> p = new List<IndexedVector3>();
			p.Capacity = points.Count;
			...
			CreateFromPoint(p, p.Count);

		}

		void CreateFromPoint(IList<IndexedVector3> points, int numPoints)
		{
