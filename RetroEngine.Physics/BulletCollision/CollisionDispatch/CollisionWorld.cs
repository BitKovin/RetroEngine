...
namespace BulletXNA.BulletCollision
{
    public class CollisionWorld
    {
        ...
        public void UpdateSingleAabb(CollisionObject colObj)
        {
            ...
            if (GetDispatchInfo().m_useContinuous && colObj.GetInternalType() == CollisionObjectTypes.RigidBody && !colObj.IsStaticOrKinematicObject())
	        {
            ...
            else
            {
                ...
                colObj.SetActivationState(ActivationState.DisableSimulation);
        ...
        {
            RayTest(ref rayFromWorld, ref rayToWorld, resultCallback);
        }
        ...
        public virtual void ConvexSweepTest(ConvexShape castShape, IndexedMatrix convexFromWorld, IndexedMatrix convexToWorld, ConvexResultCallback resultCallback, float allowedCcdPenetration = 0.001f)
        {
    ...
    public struct LocalRayResult
    {
        ...
        {
            get { return m_localShapeInfo; }
            set { m_localShapeInfo = value; }
        }

        public IndexedVector3 HitNormalLocal
        {
            get { return m_hitNormalLocal; }
            set { m_hitNormalLocal = value; }
        }
        ...
        public bool HasHit { get { return m_collisionObject != null; } }
    ...
    public abstract class RayResultCallback
    {
        ...
        {
            get { return m_closestHitFraction; }
            set { m_closestHitFraction = value; }
        }
        ...
        {
            get { return m_collisionFilterGroup; }
            set { m_collisionFilterGroup = value; }
        }

        public CollisionFilterGroups CollisionFilterMask
        {
            get { return m_collisionFilterMask; }
            set { m_collisionFilterMask = value; }
        }
    ...
    public class ClosestRayResultCallback : RayResultCallback,IDisposable
    {
        ...
        public IndexedVector3 RayFromWorld
        {
            get { return m_rayFromWorld; }
            set { m_rayFromWorld = value; }
        }

        public IndexedVector3 RayToWorld
        {
            get { return m_rayToWorld; }
            set { m_rayToWorld = value; }
        }

        public IndexedVector3 HitNormalWorld
        {
            get { return m_hitNormalWorld; }
            set { m_hitNormalWorld = value; }
        }

        public IndexedVector3 HitPointWorld
        {
            get { return m_hitPointWorld; }
            set { m_hitPointWorld = value; }
        }

        public bool HasHit { get { return CollisionObject != null; } }
    ...
    public struct LocalConvexResult
    {
        ...
        {
            get { return m_hitCollisionObject; }
            set { m_hitCollisionObject = value; }
        }
        ...
        public IndexedVector3 HitPointLocal
        {
            get { return m_hitPointLocal; }
            set { m_hitPointLocal = value; }
        }
    ...
    public abstract class ConvexResultCallback
    {
        ...
        public bool HasHit{ get { return m_closestHitFraction < 1f; } }
    ...
    public class ClosestConvexResultCallback : ConvexResultCallback
    {
        ...
        public IndexedVector3 ConvexFromWorld
        {
            get { return m_convexFromWorld; }
            set { m_convexFromWorld = value; }
        }

        public IndexedVector3 ConvexToWorld
        {
            get { return m_convexToWorld; }
            set { m_convexToWorld = value; }
        }
